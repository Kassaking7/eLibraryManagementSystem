...
const TimelineItemList = _a => {
  ...
  const itemsList = mergedItems.filter(item => !!item).map((item, idx) => {
    ...
    return /*#__PURE__*/React.createElement(_TimelineItem.default, Object.assign({
      className: (0, _classnames.default)([!reverse && !!pending ? pendingClass : readyClass, getPositionCls((_a = item === null || item === void 0 ? void 0 : item.position) !== null && _a !== void 0 ? _a : '', idx)])
    }, item, {
